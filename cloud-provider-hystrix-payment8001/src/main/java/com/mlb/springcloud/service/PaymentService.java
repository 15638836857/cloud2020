...
public class PaymentService {
    ...
    public String paymentInfo_ok(Integer id) {
        return "线程池 "+Thread.currentThread().getName()+" paymentInfo_ok,Id  "+id+"\t OK了";
    }
...
//            int i=10/0;
        ...
        return "线程池 "+Thread.currentThread().getName()+" paymentInfo_timeout,Id  "+id+"\t OK了" +"耗时："+timeout;
    }
